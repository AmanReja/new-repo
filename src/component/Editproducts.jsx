          ...
          <div className=" duration-300 blackd align-i h-[500px] pro-detail w-[500px] lg:pl-8 pr[100px] xl:px-16 max-lg:mx-auto max-lg:mt-8">
            ...
            <div className="relative  flex justify-between gap-4 w-[400px]">
              <button
                ...
                className="text-center h-[40px] w-[170px] px-5 py-4 rounded-[100px] bg-indigo-600 flex items-center justify-center font-semibold text-[15px] text-white shadow-sm shadow-transparent transition-all duration-500 hover:bg-fuchsia-700 hover:shadow-indigo-300"
              >
                Delete Book
              </button>
              <button
                ...
                className="text-center h-[40px] w-[170px] px-5 py-4 rounded-[100px] bg-red-600 flex items-center justify-center font-semibold text-[15px] text-white shadow-sm shadow-transparent transition-all duration-500 hover:bg-lime-400 hover:shadow-indigo-300"
              >
                Edit Book
              </button>
            </div>
